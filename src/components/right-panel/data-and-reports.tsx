...
const PublishWorkflow = dynamic(
  () => import("@/components/right-panel/publish-workflow").then((m) => ({ default: m.PublishWorkflow })),
  { loading: () => <OpsSectionSkeleton />, ssr: false }
);
...
const CompetitorRadar = dynamic(
  () => import("@/components/right-panel/competitor-radar").then((m) => ({ default: m.CompetitorRadar })),
  { ssr: false, loading: () => <SectionSkeleton title="竞品雷达图" icon={Crosshair} /> }
);
const CompetitorTrends = dynamic(
  () => import("@/components/right-panel/competitor-trends").then((m) => ({ default: m.CompetitorTrends })),
