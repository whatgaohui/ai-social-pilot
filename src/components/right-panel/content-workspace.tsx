...
const InlineEngagementBar = React.memo(function InlineEngagementBar({ post, isXHS }: { post: ContentPost; isXHS: boolean }) {
  const updateContentPost = useContentStore((s) => s.updateContentPost);
...
export function ContentWorkspace() {
  ...
  const setAccountPanelOpen = useUIStore((s) => s.setAccountPanelOpen);
