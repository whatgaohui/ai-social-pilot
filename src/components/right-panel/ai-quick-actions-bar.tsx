            ...
            <div className="relative flex items-center gap-2 px-3 py-2.5 rounded-xl bg-background/85 backdrop-blur-xl border border-white/20 dark:border-white/10 shadow-[0_-4px_24px_rgba(0,0,0,0.08)] dark:shadow-[0_-4px_24px_rgba(0,0,0,0.3)]">
              ...
              <div className="flex items-center justify-center mr-1">
                <motion.div
                  ...
                  transition={isStreaming ? { duration: 0.6, repeat: Infinity, ease: "easeInOut" } : {}}
                >
                  <Sparkles className={`h-4 w-4 ${isStreaming ? "text-violet-500" : "text-muted-foreground"}`} />
                </motion.div>
              </div>
              ...
              <div className="flex items-center gap-1.5 flex-1">
                <TooltipProvider delayDuration={400}>
                  {actions.map((action, idx) => {
                    ...
                    const isDisabled = isLoading || (isStreaming && !isLoading);
              ...
              {isStreaming && (
                <motion.button
                  ...
                  className="flex items-center gap-1 px-2 py-1.5 rounded-lg text-xs font-medium text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-colors cursor-pointer"
                >
