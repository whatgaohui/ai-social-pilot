          ...
          {categories.map((cat) => {
            ...
            return (
              <button
                key={cat.key}
                className={cn(
                  "relative flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-200 btn-press",
                  isActive
              ...
              >
                ...
                {count > 0 && (
                  <span
                    className={cn(
                      "min-w-[16px] h-4 text-[10px] font-bold rounded-full flex items-center justify-center px-1",
                      isActive
                        ? "bg-white/25 text-white"
                        : "bg-xhs/15 text-xhs dark:bg-xhs/20 dark:text-xhs-300"
                    )}
                  >
                    {count > 99 ? "99+" : count}
                  </span>
